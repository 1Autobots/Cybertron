...
# https://github.com/salihmarangoz/image2gazebo/blob/master/create_world.sh
...
echo "$MODEL_NAME"
echo "$STL_FILE"
png23d -w "$MODEL_WIDTH" -h "$MODEL_HEIGHT" -d "$CELL_HEIGHT" -o stl "$PNG_FILE" "$MODEL_NAME/$STL_FILE"
